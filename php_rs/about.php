...
<!-- visi & misi-->
	<div class="testimonials">
		<div class="container">
			<h3 class="tittle">Visi & Misi</h3>
			<div class="testimonials-grids">
				<div class="col-md-6 testimonials-grid animated wow slideInLeft" data-wow-delay=".5s">
					<div class="testimonials-grid1">
						<img src="images/visi.png" alt=" " class="img-responsive" />
						<p>Visi</p>
					</div>
					<div class="testimonials-grid2">
						<p>Menjadikan Rumah Sakit yang terbaik dan terjangkau oleh masyarakat</p>
					</div>
				</div>
				<div class="col-md-6 testimonials-grid animated wow slideInRight" data-wow-delay=".5s"">
					<div class="testimonials-grid1">
						<img src="images/misi.png" alt=" " class="img-responsive" />
						<p>Misi</p>
					</div>
					<div class="testimonials-grid2">
						<p>1. Mengutamakan Pasien Safety, <br>2. Meningkatkan mutu pelayanan secara berkesinambungan,<br>3. Memberikan pelayanan yang efektif dan efisien.</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
